...
changed behavior affects logic, contracts, tenant boundaries, accessibility, UX
states, observability, or performance/reliability expectations. Only omit
automated tests when the spec explicitly documents why no meaningful automated
check applies.
...
- [ ] T004 [P] Document constitution checks, verification commands, and
      performance/reliability targets for this feature
...
- [ ] T009 Configure error handling and logging/tracing infrastructure
- [ ] T010 Setup environment configuration management
- [ ] T011 [P] Define observability, tenant-isolation, and idempotency hooks
...
> **NOTE: Write the constitution-required tests FIRST, ensure they FAIL before
> implementation**
...
- [ ] T014 [P] [US1] Unit or route/component test for changed local behavior
...
- [ ] T019 [US1] Add validation, error handling, and explicit user/API states
- [ ] T020 [US1] Add logs, metrics, tracing, or accessibility hooks required for
      user story 1
...
- [ ] T023 [P] [US2] Unit or route/component test for changed local behavior
...
- [ ] T030 [P] [US3] Unit or route/component test for changed local behavior
...
- [ ] TXXX [P] Additional automated tests required by changed behavior
- [ ] TXXX Review accessibility, observability, and tenant/security hardening
- [ ] TXXX Run constitution-aligned verification commands
...
- Verify constitution-required tests fail before implementing
- Commit after each task or logical group
- Stop at any checkpoint to validate story independently
- Avoid: vague tasks, same file conflicts, cross-story dependencies that break
  independence, and missing observability/UX/performance validation work
