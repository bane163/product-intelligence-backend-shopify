    ...
    def __init__(self, target: Any) -> None:
        ...
        self.runs = SupabaseNamespace(
            ...
            (
                ...
                "cancel_run_cascade",
                "transition_offload_workflow",
            ),
            aliases={
                "create_or_update": "create_or_update_run",
                "append_event": "append_run_event",
                "latest_event_seq": "get_latest_run_event_seq",
        ...
        self.intelligence = SupabaseNamespace(
            ...
            (
                ...
                "list_product_intelligence_audit_artifacts",
                ...
                "mark_product_intelligence_suggestion_reverted",
